...
fn verify_substrate_storage_read_proof_given_hashes(buffer: Span<u8>, buffer_node_index: Span<usize>, key: Span<u8>, root: Span<u8>, hashes: Span<u8>) -> Result<Slice<u8>,felt252>{
...
fn verify_substrate_storage_read_proof(buffer: Span<u8>, buffer_node_index: Span<usize>, key: Span<u8>, root: Span<u8>) -> Result<Slice<u8>,felt252>{
